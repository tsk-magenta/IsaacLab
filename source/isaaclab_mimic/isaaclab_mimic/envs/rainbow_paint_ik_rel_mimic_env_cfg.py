...
from isaaclab_tasks.manager_based.manipulation.paint.config.franka.paint_ik_rel_env_cfg import FrankaPaintEnvCfg


@configclass
class RainbowPaintIKRelMimicEnvCfg(FrankaPaintEnvCfg, MimicEnvCfg):
    """
    Isaac Lab Mimic environment config class for Rainbow Paint IK Rel env.
    """
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "demo_src_paint_isaac_lab_task_D0"
        ...
        self.subtask_configs["rainbow"] = subtask_configs
