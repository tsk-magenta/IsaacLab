...
from isaaclab_tasks.manager_based.manipulation.paint.paint_instance_randomize_env_cfg import (
    PaintInstanceRandomizeEnvCfg,
)
...
class EventCfg:
    ...
    randomize_cubes_in_focus = EventTerm(
        func=franka_paint_events.randomize_rigid_objects_in_focus,
        mode="reset",
        params={
...
@configclass
class FrankaPaintInstanceRandomizeEnvCfg(PaintInstanceRandomizeEnvCfg):
